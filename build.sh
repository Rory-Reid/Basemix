...
dotnet publish src/Basemix/Basemix.csproj -c Release -f net7.0-maccatalyst --no-restore -p:BuildIpa=True
...
dotnet build src/Basemix/Basemix.csproj -c Release -f net7.0-ios --no-restore /p:buildForSimulator=True /p:packageApp=True /p:ArchiveOnBuild=False