...
public class BredLittersOverviewTests : StatsSqliteIntegration
{
    private readonly Faker faker = new();
    private readonly StatsSqliteFixture fixture;
    private readonly SqliteStatisticsRepository repository;

    public BredLittersOverviewTests(StatsSqliteFixture fixture) : base(fixture)
    {
    ...
    public async Task Returns_stats_for_bucks_and_does()
    {
        ...
        foreach (var rat in notBredRats.Take(this.faker.Random.Int(1, notBredRats.Count))) // Seed some in an non-bred litter, some not connected
        {
    ...
    public async Task Returns_stats_for_litter_sizes()
    {
        ...
        foreach (var rat in notBredRats.Take(this.faker.Random.Int(1, notBredRats.Count))) // Seed some in an non-bred litter, some not connected
        {
            await this.fixture.LittersRepository.AddOffspring(notBredLitter.Id, rat.Id);
        }
