...
public class SqliteStatisticsRepositoryTests : StatsSqliteIntegration
{
    private readonly Faker faker = new();
    private readonly StatsSqliteFixture fixture;
    private readonly SqliteStatisticsRepository repository;
    
    public SqliteStatisticsRepositoryTests(StatsSqliteFixture fixture) : base(fixture)
    {
    ...
    public async Task Can_get_litter_count()
    {
        ...
        var unbredLitterCount = this.faker.Random.Int(1, 10);
        ...
        var makeUnbredLitters = this.faker.Make(unbredLitterCount,  async () =>
        {
        ...
        await Task.WhenAll(makeUnbredLitters);
        
        var statistics = await this.repository.GetStatisticsOverview();
        statistics.System.ShouldSatisfyAllConditions(
            stats => stats.TotalLitters.ShouldBe(bredLitterCount + unbredLitterCount),
