...
public static class FakerExtensions
{
    ...
    {
        public long Id() => faker.Random.Long(1);

        public T PickNonDefault<T>(params T[] except) where T : struct, Enum =>
            faker.PickRandom(Enum.GetValues<T>().Except(new[] {default(T)}.Concat(except)));

        public string Variety() =>
            faker.PickRandom(Varieties);

        public Rat Rat(RatIdentity? id = null, string? name = null, Sex? sex = null,
        ...
        public Owner Owner(OwnerIdentity? id = null)
        {
        ...
        public EstimationParameters EstimationParameters()
        {
        ...
        public DeathReason DeathReason(string? name = null) =>
